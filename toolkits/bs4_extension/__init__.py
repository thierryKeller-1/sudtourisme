...
def get_element_by_locator(element:object, locator:dict) -> object | None:
    ...
    if locator.get('by_tag_only'):
        element_found = element.find(locator.get('tag'))
        return element_found
    else:
        element_found = element.find(locator.get('tag'), {locator.get('attr_key'):locator.get('attr_value')})
        return element_found
...
def get_all_element_by_locator(element:object, locator:dict) -> object | None:
    ...
    """
    show_message('info', "getting all element by locator", True)
    if locator['by_tag_only']:
...
def extract_element_by_locator(element:object, locator:dict) -> object | None:
    ...
    if element:
        ...
        show_message('info', 'element not found', True)
        return
