...
def set_dates(driver, start_date:str, end_date:str) -> None:
    ...
    try:
        driver.scroll_into_view("input[id='datepicker-v-0-1-8-0-start']")
        time.sleep(1)
        driver.run_js(f"""
            let date_start = document.getElementById('datepicker-v-0-1-8-0-start');
            ...
            let date_end = document.getElementById('datepicker-v-0-1-8-0-end');
